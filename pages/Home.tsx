...
export const ethnicData: EthnicGroup[] = [
  ...
  { name: "Mảng", location: "Tỉnh Lai Châu", population: 4650, coords: [22.3, 102.8], description: "Sống ven sông Đà, giỏi nghề sông nước và đánh bắt cá.", heritage: "Gùi, Rổ tre, Vải dệt.", img: "pictures-54dantoc/mang.jpg" },
